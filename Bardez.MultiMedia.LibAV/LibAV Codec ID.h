...
#ifndef _ENUMS_CODECID_
#define _ENUMS_CODECID_
		...
		namespace Multimedia
		{
			namespace LibAV 
			{
				...
				public enum struct LibAVCodecID : System::UInt32
				{
					...
					/// <remarks>preferred ID for MPEG-1/2 video decoding</remarks>
					CODEC_ID_MPEG2VIDEO,
					...
					/// <summary>as found in WAV</summary>
					CODEC_ID_GSM_MS,
					CODEC_ID_ATRAC3,
					CODEC_ID_VOXWARE,
					CODEC_ID_APE,
					...
					/// <summary>_FAKE_ codec to indicate a MPEG-2 TS stream (only used by libavformat</summary>
